<template>
    <div
        ...
        class="bg-white inline-block rounded hover:shadow-sm cursor-pointer"
    >
        <NuxtLink :to="`/item/${product.id}`">
            ...
            <div id="ProductDetails">
                ...
                <span class="px-1 relative -top-1.5 text-[#FF6674] font-semibold text-xs"
                    >Extra 5% off
                </span>
                ...
                <p class="text-[#009A66] text-xs font-semibold pb-1 px-1">Free Shippng</p>
            </div>
        </NuxtLink>
    </div>
</template>
